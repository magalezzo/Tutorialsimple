...
\author[1]{\normalsize Maria Angelica Galezzo Martinez}
\author[2]{\normalsize Jesus David Molina Paez}
...
\usepackage{Sweave}
\begin{document}
\input{paperVersion6-concordance}
...
\begin{figure}[h]
\centering
\includegraphics{paperVersion6-barplots}
...
% Date and time: Fri, Jun 29, 2018 - 15:03:40
...
\includegraphics{paperVersion6-corrPlotX}
\end{adjustbox}
...
\includegraphics{paperVersion6-plotMap1}
\end{adjustbox}
